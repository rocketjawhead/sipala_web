                    ...
                    <div class="card">
                        ...
                        <div class="deposit">
                            <div class="">
                                ...
                                <p style="font-weight: bold;">PLN</p>
                                </center>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-2" id="paket_data">
                    <div class="card">
                        ...
                        <div class="deposit">
                            <div class="">
                                <center>
                                <img src="<?php echo base_url()?>assets/img/provider/pdam.png" alt="" style="width:50%;height:50%;">
                                <p style="font-weight: bold;">PDAM</p>
                                </center>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="deposit">
                            <div class="">
                                ...
                                <p style="font-weight: bold;">Internet Pascabayar</p>
                                </center>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-2" id="emoney">
                    <div class="card">
                        ...
                        <div class="deposit">
                            <div class="">
                                <center>
                                <img src="<?php echo base_url()?>assets/img/provider/bpjs.png" alt="" style="width:50%;height:50%;">
                                <p style="font-weight: bold;">BPJS</p>
                                </center>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-2" id="emoney">
                    <div class="card">
                        ...
                        <div class="deposit">
                            <div class="">
                                <center>
                                <img src="<?php echo base_url()?>assets/img/provider/bpjs_icon.png" alt="" style="width:50%;height:50%;">
                                <p style="font-weight: bold;">Multifinance</p>
                                </center>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="deposit">
                            <div class="">
                                <center>
                                <img src="<?php echo base_url()?>assets/img/provider/bpjs_icon.png" alt="" style="width:50%;height:50%;">
                                <p style="font-weight: bold;">PBB</p>
                                </center>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="deposit">
                            <div class="">
                                <center>
                                <img src="<?php echo base_url()?>assets/img/provider/paketdata.png" alt="" style="width:50%;height:50%;">
                                <p style="font-weight: bold;">TV Pascabayar</p>
                                </center>
                            </div>
                        </div>
                    </div>
