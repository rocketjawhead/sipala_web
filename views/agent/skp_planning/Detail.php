<main id="main" class="main">
              ...
              <!-- General Form Elements -->
                ...
                <div class="field item form-group">
                    ...
                    <div class="col-md-12 col-sm-12">
                        <select class="form-control act_favorite basic-single" id="id_skp_unit" required>
                            <option value="<?php echo $id_skp_unit;?>"> Data Terpilih : <?php echo $skp_unit;?></option>
                            <?php
                ...
                <div class="field item form-group">
                    <label class="col-form-label col-md-3 col-sm-3  label-align">SKP Rencana Kinerja</label>
                    <div class="col-md-12 col-sm-12">
  ...
  <script type="text/javascript">
    function exec_form(){
        ...
        $.ajax({
            url : "<?php echo base_url();?>agent/Skpplanning/update",
            method : "POST",
            data : {
                id : id,
                title : title,
