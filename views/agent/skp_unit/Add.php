<main id="main" class="main">
            ...
            <div class="card-body">
              ...
              <!-- General Form Elements -->
                <div class="field item form-group">
                    <label class="col-form-label col-md-3 col-sm-3  label-align">Judul SKP Unit</label>
  ...
  <script type="text/javascript">
    function exec_form(){
        ...
        $.ajax({
            url : "<?php echo base_url();?>agent/Skpunit/insert",
            method : "POST",
            data : {
                title : title_jabatan
            },
            ...
            success: function(data){
              var url = '<?php echo base_url();?>agent/Skpunit/';
              window.location = url;
            }
          });
