<main id="main" class="main">
            ...
            <div class="card-body">
              ...
              <!-- General Form Elements -->
                <div class="field item form-group">
                    <label class="col-form-label col-md-3 col-sm-3  label-align">Judul Tempat</label>
  ...
  <script type="text/javascript">
    function exec_form(){
        ...
        $.ajax({
            url : "<?php echo base_url();?>agent/Place/update",
            method : "POST",
            data : {
                id : id,
                title : title,
            ...
            success: function(data){
              var url = '<?php echo base_url();?>agent/Place/';
              window.location = url;
            }
          });
