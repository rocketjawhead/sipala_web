            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body" style="margin-top: 20px;">
                  <h5 class="card-title">Tambah Data 
                    <a href="<?php echo base_url('agent/Activity/add');?>" class="btn btn-outline-primary">+</a>
                  </h5>
                      ...
                      <tr>
                        ...
                        <!-- <td>
                          <?php if($row->imageurl == null){?>
                            <img id="image1" style="height: 10%;width: 10%;" src="<?php echo base_url()?>assets_v2/assets/img/no_image.png"/>
                          <?php }else{?>
                            <img id="image1" style="height: 10%;width: 10%;" src="<?php echo $row->imageurl;?>"/>
                          <?php }?>
                        </td> -->
                        ...
                        <td><span class="badge <?php echo $row->status_badged;?>"><?php echo $row->status_approved;?></span></td>
