            ...
            <div class="card-body">
              ...
              <!-- General Form Elements -->
                ...
                <div class="field item form-group">
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="row">
                            <div class="col-sm-6">
                                <label>Jam</label>
                                <input class="form-control" name="email" id="start_time" type="time" />
                            </div>
                            <div class="col-sm-6">
                                <label>Ke</label>
                                <input class="form-control" name="email" id="end_time" type="time" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="field item form-group">
                    ...
                    <div class="col-md-12 col-sm-12">
                        <!-- manual input -->
                        <input class="form-control act_manual" name="email" id="act_manual" type="text" />
                        <!-- get from favorite -->
                        <select class="form-control act_favorite basic-single" id="act_favorite" style="display: none;">
                ...
                <div class="field item form-group">
                    ...
                    <div class="col-md-12 col-sm-12">
                        <!-- manual input -->
                        <input class="form-control place_manual" name="email" id="place_manual" type="text" />
                        <!-- get from favorite -->
                        <select class="form-control place_favorite basic-single" id="place_favorite" style="display: none;">
                            <option value="">--- Silahkan Pilih ---</option>
                            <?php
                ...
                <div class="field item form-group">
                    ...
                    <div class="col-md-12 col-sm-12">
                        <!-- manual input -->
                        <input class="form-control organizer_manual" name="email" id="organizer_manual" type="text" />
                        <!-- get from favorite -->
                        <select class="form-control organizer_favorite basic-single" id="organizer_favorite" style="display: none;">
                            <option value="">--- Silahkan Pilih ---</option>
                            <?php
