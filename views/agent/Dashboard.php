            ...
            <?php }else{?>
              <div class="card-body">
                ...
                <br><hr/>
                  ...
                  <!-- <?php if($sick_time_absent == null){?> 
                    <div class="row sick_leave" id="sick_leave" style="display: none;">
                    <a onClick="exec_sick();" class="btn btn-outline-primary btn-sm" >Izin/Sakit</a>
                  <?php }else{ ?>
                    <div class="row sick_leave" id="sick_leave">
                      <p>Status : <?php echo $sick_desc_absent;?></p>
                  <?php } ?>
                    </div> -->

                  <?php if($today_act == 2 || $today_act == 3 || $today_act == 4){?>

                    <center>
                      <h4><?php echo 'Status : '.$today_act_desc;?></h4>
                    </center>

                  <?php }else{?>
                      <?php if($start_time_absent == null){?> 
                      <div class="row absent" id="absent">
                      <?php }else{ ?>
                      <div class="row absent" id="absent">
                      <?php } ?>
                        <div class="col-md-6">
                          <p>Jam Hadir</p>
                          <?php if($start_time_absent == null){?> 
                            <a onClick="exec_startabsent();" class="btn btn-outline-primary btn-sm" >Mulai</a>
                          <?php }else{ ?>
                            <?php echo $start_time_absent;?>
                          <?php } ?>
                        </div>
                        <div class="col-md-6">
                          <p>Jam Pulang</p>
                          <?php if($start_time_absent != null){?> 
                            <?php if($end_time_absent == null){?> 
                              <a onClick="exec_gohome();" class="btn btn-outline-primary btn-sm" >Pulang</a>
                            <?php }else{ ?>
                              <?php echo $end_time_absent;?>
                            <?php } ?>
                          <?php }else{ ?>
                            <p>-</p>
                          <?php } ?>  
