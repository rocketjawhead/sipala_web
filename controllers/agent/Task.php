...
class Task extends CI_Controller {
	...
	public function index(){
        ...
        //list data
        $url_bank = 'api/Master/listtask';
        $exec_bank = $this->base->post_curl($url_bank,$data_user);
        $data['list_task'] = $exec_bank['Data'];
        //
        
        $this->load->view('menu/Header',$data);
        $this->load->view('agent/task/Index',$data);
    ...
    public function add(){
        ...
        $this->load->view('menu/Header',$data);
        $this->load->view('agent/task/Add',$data);
        $this->load->view('menu/Footer',$data);
    }
    ...
    public function detail($id){
        ...
        $this->load->view('menu/Header',$data);
        $this->load->view('agent/task/Detail',$data);
        $this->load->view('menu/Footer',$data);
    }
