...
class Jabatan extends CI_Controller {
	...
	public function index(){
        ...
        //list data
        $url_bank = 'api/Master/listjabatan';
        $exec_bank = $this->base->post_curl($url_bank,$data_user);
        $data['list_jabatan'] = $exec_bank['Data'];
        //
        
        $this->load->view('menu/Header',$data);
        $this->load->view('agent/jabatan/Index',$data);
    ...
    public function add(){
        ...
        $this->load->view('menu/Header',$data);
        $this->load->view('agent/jabatan/Add',$data);
        $this->load->view('menu/Footer',$data);
    }
    ...
    public function detail($id){
        ...
        $this->load->view('menu/Header',$data);
        $this->load->view('agent/jabatan/Detail',$data);
        $this->load->view('menu/Footer',$data);
    }
