...
class Skpunit extends CI_Controller {
	...
	public function index(){
        ...
        $this->load->view('agent/skp_unit/Index',$data);
    ...
    public function add(){
        ...
        $this->load->view('menu/Header',$data);
        $this->load->view('agent/skp_unit/Add',$data);
        $this->load->view('menu/Footer',$data);
    }
    ...
    public function detail($id){
        ...
        $this->load->view('menu/Header',$data);
        $this->load->view('agent/skp_unit/Detail',$data);
        $this->load->view('menu/Footer',$data);
    }
