...
class Gelar extends CI_Controller {
	...
	public function index(){
        ...
        //list data
        $url_bank = 'api/Master/listgelar';
        $exec_bank = $this->base->post_curl($url_bank,$data_user);
        $data['list_gelar'] = $exec_bank['Data'];
        //
        
        $this->load->view('menu/Header',$data);
        $this->load->view('agent/gelar/Index',$data);
    ...
    public function add(){
        ...
        $this->load->view('menu/Header',$data);
        $this->load->view('agent/gelar/Add',$data);
        $this->load->view('menu/Footer',$data);
    }
    ...
    public function detail($id){
        ...
        $this->load->view('menu/Header',$data);
        $this->load->view('agent/gelar/Detail',$data);
        $this->load->view('menu/Footer',$data);
    }
